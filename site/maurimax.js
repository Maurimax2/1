...
ar: {
  ...
  stats:[ {n:'20,000+',l:'قناة مباشرة',h:'من كل قارات العالم'},
          {n:'15,000+',l:'فيلم',h:'من أضخم الأعمال إلى الكنوز المخفية'},
  ...
  why:{ eyebrow:'لماذا موريماكس', titleA:'تجربة', titleB:'تستحق الاشتراك.',
    ...
    items:[
      ...
      {t:'مكتبة ضخمة',b:'أكثر من 20 ألف قناة و15 ألف فيلم و10 آلاف مسلسل في مكان واحد.'},
...
fr: {
  ...
  stats:[ {n:'20,000+',l:'Chaînes en direct',h:'De tous les continents'},
          {n:'15,000+',l:'Films',h:'Des blockbusters aux pépites'},
  ...
  why:{ eyebrow:'Pourquoi MAURIMAX', titleA:'Une expérience', titleB:'qui vaut l’abonnement.',
    ...
    items:[
      ...
      {t:'Bibliothèque immense',b:'Plus de 20 000 chaînes, 15 000 films et 10 000 séries au même endroit.'},
...
var CATS = [
  {art:'movies',   photo:'m-fury',        ar:['أفلام','أكثر من 15,000 فيلم'],    fr:['Films','Plus de 15 000 films']},

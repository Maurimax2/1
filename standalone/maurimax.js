...
ar: {
  ...
  why:{ eyebrow:'لماذا موريماكس', titleA:'تجربة', titleB:'تستحق الاشتراك.',
    ...
    items:[
      ...
      {t:'مكتبة ضخمة',b:'أكثر من 20 ألف فيلم و15 ألف مسلسل و9 آلاف قناة في مكان واحد.'},
...
fr: {
  ...
  why:{ eyebrow:'Pourquoi MAURIMAX', titleA:'Une expérience', titleB:'qui vaut l’abonnement.',
    ...
    items:[
      ...
      {t:'Bibliothèque immense',b:'Plus de 20 000 films, 15 000 séries et 9 000 chaînes au même endroit.'},

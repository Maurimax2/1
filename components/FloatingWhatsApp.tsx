...
export function FloatingWhatsApp() {
  ...
  return (
    <AnimatePresence>
      {show && (
        <motion.a
          href={waLink('Hello MOORTV, I would like to place an order.')}
          target="_blank"
          ...
          className="group fixed bottom-5 right-5 z-40 flex items-center gap-0 overflow-hidden rounded-full bg-[linear-gradient(135deg,#059669,#10b981)] p-4 text-white shadow-[0_18px_45px_-14px_rgba(16,185,129,0.9)] transition-all duration-500 hover:gap-2.5 hover:pr-6 sm:bottom-7 sm:right-7"
          aria-label={`Order on WhatsApp — ${SITE.whatsappDisplay}`}
        >
